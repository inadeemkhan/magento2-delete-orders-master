 ...
 */
namespace Magelumen\DeleteOrders\Controller\Adminhtml\Order;
  ...
  public function __construct(
    ...
    protected function massAction(AbstractCollection $collection)
    {
        ...
        foreach ($collection->getItems() as $order) {
            ...
            array_push($deletedIncIds, "#".$incId);
            $countCancelOrder++;
        }
        ...
        if ($countCancelOrder) {
            $deletedOrders = implode(', ', $deletedIncIds);
            $this->messageManager->addSuccess(__('Order(s) %1 have been deleted successfully.', $deletedOrders));
        }
